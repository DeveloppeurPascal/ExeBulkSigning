...
>
> La maintenance de ce projet est déplacée vers Codeberg sur https://codeberg.org/PatrickPremartin/ExeBulkSigning
>
...
> [!NOTE]
> Pour ouvrir ou intervenir sur un ticket de ce projet, rendez-vous sur https://codeberg.org/PatrickPremartin/ExeBulkSigning/issues
> Pour faire un PULL REQUEST sur ce projet, rendez-vous sur https://codeberg.org/PatrickPremartin/ExeBulkSigning/pulls
> Pour toute autre information ou me contacter vous pouvez aussi consulter le site Internet du projet sur https://exebulksigning.olfsoftware.fr ou son devlog sur https://exebulksigning.olfsoftware.fr/dev-corner.html
